...
#votepid='5627'
#isVote=1
def puVote_new(username,userpassword,id,votepid,isVote=1):
    #加入对cookies的支持
    ...
    #投票的url
        url_vote='http://sytu.pocketuni.net/index.php'
    #对data加入url编码
    #投票的url参数
    #POST /index.php?app=event&mod=Front&act=vote HTTP/1.1
        data_values = {'app' : 'event','mod' : 'Front','act' : 'vote1'}
        data = urllib.parse.urlencode(data_values)
    #创建Request对象
