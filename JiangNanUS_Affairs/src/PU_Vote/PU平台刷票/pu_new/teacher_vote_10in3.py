from autoVote_PU_new import puVote_new
import xlrd
import xlwt
import os
import time
...
if(isVote==1):
    ...
    for i in range(nrows ):
        ...
        for ii in range(len_pid):
            ...
            result=puVote_new(name,password,id,pid[ii],1)
        ...
        print("   ",end="   ")
        ok_num=need_vote_num-len_pid ;
        for iii in range( need_vote_num-len_pid ):
            result=puVote_new(name,password,id,otherpid[i_other],1)
            if(result['vote_state']==1):
